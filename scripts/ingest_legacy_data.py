...
project_root = script_dir.parent  # climbs up 1 level to project root
...
# Map clean columns to a messy 2000s legacy enterprise schema
legacy_mapping = {
    "timestamp": "TS_UTC",
...
# Connect to Docker MSSQL Server
print("Connecting to legacy MSSQL Database...")
# Use the pyodbc driver. (Ensure you have ODBC Driver 17 or 18 for SQL Server installed.)
